...
* **Mean:** `r sprintf("%.2f", act_mean)`

* **Median:** `r sprintf("%.2f", act_median)`
...
Maximum of average number of steps **[`r round(max(Act.pat$steps))`]** occured at **`r  Act.pat$interval[Act.pat$steps == max(Act.pat$steps)]`**.
